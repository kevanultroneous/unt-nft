...
const CaseStudy = () => {
    ...
    const carddatas = [
        {
            ...
            dish1: "Problem",
            disp1: "In this case, the client wanted a blockchain-based fundraising platform that allows investors and start-ups to meet and create an ecosystem of transparency with native security tokens for fundraising.",
            dish2: "Solution",
            disp2: "We provided a product with an EtherGo Blockchain-based Investor-Relationship dashboard. That has SEC Complaint ERC 700 series Security token also Reg D offering for Accredited investors."
        },
        {
            animtype: "fade-up",
    ...
    const categories = [
        "All", "MxTrade", "MxFuture", "MxDex", "MxFi", "MxLaunch", "MxWallet", "MxBlock", "MxNFT"
    ]
    ...
    return (
        <Layout title={"case-study"}>
            ...
            <div className={styles.MainTitleContain}>
                <MainTitle title={"MobifinX Case Studies"} btntext={"Try Free Demo"} />
            </div>
                ...
                <Row className={styles.CenterModeTab}>
                        ...
                        <div className={styles.TabSection}>
                            <p className={styles.CategoriesTitle}>Categories</p>
                            {
                                categories.map((value, index) =>
                                    <p className={`${styles.CategoriesList} ${index === currentTab && `${styles.CategoriesListSelected} ${styles.BorderSelected}`}`}
                    ...
                    <Col md={5} xl={5} lg={5} className={styles.RightCol}>
                        ...
                        <div className={styles.VisibilityTabOff}>
                            <h4 className={styles.CardRightSectionBottomTitle}>Want to Experience
                                Our platforms?</h4>
                            <div className={styles.ButtonWrraper}>
                                <ActionButton text={<div className={styles.ButtonText}><span >Yes, Please</span> <HiOutlineExternalLink /></div>} />
                            </div>
                        </div>
                    </Col>
                    {/* for only tablet */}
